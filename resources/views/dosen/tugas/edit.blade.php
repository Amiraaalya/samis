            ...
            <div class="grid grid-cols-1 gap-5">
                ...
                <div>
                    ...
                    <textarea name="deskripsi" rows="4"
                              class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-teal-400">{{ old('deskripsi', $tugas->deskripsi) }}</textarea>
                </div>
